...
fn main() {
    let data1 = vec!["a", "b", "c", "d" , "e" , "f" , "g" , "h" , "i" , "j" , "k" , "l" , "m" , "n" , "o" , "p" , "q" , "r" , "s" , "t" , "u" , "v" , "w" , "x" , "y" , "z"];
    let tree1 = MerkleTree::new(data1);

    let data2 = vec!["a", "b", "c", "d" , "e" , "f" , "3" , "h" , "i" , "j" , "k" , "l" , "m" , "n" , "hdfdsfgwdferfgsdxcerd" , "p" , "q" , "r" , "s" , "t" , "u" , "v" , "w" , "x" , "y" , "z"];
    let tree2 = MerkleTree::new(data2);

    

    let start = Instant::now();
    let result = compare_merkle_trees(&tree1, &tree2);
    let duration = start.elapsed();
    println!("Time taken by function2: {:?}", duration);
    println!("Tampered result array: {:?} {:?}", result,result.len());
